...
function testImprovedContentGeneration() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const structureBrain = new DocumentStructureBrain_1.DocumentStructureBrain();
            const structureResult = yield structureBrain.invoke(mockState);
            console.log('✅ Structure Generated:');
            console.log(((_a = structureResult.documentStructure) === null || _a === void 0 ? void 0 : _a.substring(0, 300)) + '...\n');
            // Test 2: Content Generation
            console.log('📝 Test 2: Content Generation');
            const contentBrain = new ContentGeneratorBrain_1.ContentGeneratorBrain();
            const contentResult = yield contentBrain.invoke(structureResult);
            console.log('✅ Content Generated:');
            console.log('Content Length:', (_b = contentResult.finalDocument) === null || _b === void 0 ? void 0 : _b.length);
            console.log('First 500 characters:');
            console.log(((_c = contentResult.finalDocument) === null || _c === void 0 ? void 0 : _c.substring(0, 500)) + '...\n');
            // Test 3: Validation
